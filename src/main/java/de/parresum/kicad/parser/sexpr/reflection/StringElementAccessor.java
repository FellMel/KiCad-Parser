...
public class StringElementAccessor extends StringAccessor implements ElementAccessor {
   ...
   public StringElementAccessor(final Field field, final SExprSymbol symbol) {
      super(field, symbol.symbolSetType() == SExprSymbolType.TREAT_PARAM_AS_ONE_STRING);
   ...
   @Override
   public String createInstance(final String value)
         throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
      return parse(value);
   }
