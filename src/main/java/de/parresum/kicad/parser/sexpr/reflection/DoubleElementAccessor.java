...
public class DoubleElementAccessor extends DoubleAccessor implements ElementAccessor {

   private final String symbolName;

   public DoubleElementAccessor(final Field field, final SExprSymbol symbol) {
      super(field);
   ...
   @Override
   public Object createInstance(final String value) throws InstantiationException, IllegalAccessException,
